...
const STR = {
  ...
  "eff.histTitle": ["Más eficaz vs. menos eficaz — por jornada (grupos)", "Most vs. least efficient — by matchday (groups)"],
  "eff.cumTitle": ["Más eficaz vs. menos eficaz — acumulado", "Most vs. least efficient — cumulative"],
  "eff.histFoot": ["Solo fase de grupos (J1–J3), la única fase completa · las eliminatorias se añadirán al terminar cada ronda · ilustrativo",
                   "Group stage only (MD1–MD3), the only completed phase · knockout rounds added as each one finishes · illustrative"],
